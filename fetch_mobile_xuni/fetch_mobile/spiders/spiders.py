...
class FetchMobileSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for each in xpath_handles:
            ...
            for city_xpath in city_xpaths:
                # city_name = city_xpath.xpath('text()').extract()
    ...
    def parse_list_page(self, response):
        ...
        # xpath_num = sel.xpath("//div[@class='haoduan-hd main'][1]/div[@class='hd_result']/div[@class='hd_mar']/div[@class='hd_number']/a")#移动联通电信
        xpath_num = sel.xpath("//div[@class='haoduan-hd main'][1]/div[@class='hd_result']/div[4]/div[@class='hd_number']/a") #虚拟
